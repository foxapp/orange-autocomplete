...
const API_URL = 'https://gist.githubusercontent.com/foxapp/428f0e59c615f5c4ab2534a2a6728782/raw/ce0488475711b53805ebce13a07da5c6d137df4d/orange-autocomplete-api.json';

class AdvancedProvider {
	constructor() {
		// offer suggestions only when editing plain text or HTML files
		this.selector = '.text.plain, .text.html.basic, .text.html.php, .text.php';
		//this.selector = '*';
	...
	inflateSuggestion(replacementPrefix, suggestion) {
		return {
			...
			type: 'snippet',
			rightLabelHTML: '<span class="aab-right-label">Templates</span>' // look in /styles/atom-slds.less
		};
	}
